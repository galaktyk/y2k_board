...
pub const WHITE: [f32; 4] = [242.0 / 255.0, 240.0 / 255.0, 229.0 / 255.0, 1.0]; // rgb(242, 240, 229)
pub const GRAY_0: [f32; 4] = [184.0 / 255.0, 181.0 / 255.0, 185.0 / 255.0, 1.0]; // rgb(184, 181, 185)
pub const GRAY_1: [f32; 4] = [134.0 / 255.0, 129.0 / 255.0, 136.0 / 255.0, 1.0]; // rgb(134, 129, 136)
pub const GRAY_2: [f32; 4] = [100.0 / 255.0, 99.0 / 255.0, 101.0 / 255.0, 1.0]; // rgb(100, 99, 101)
pub const GRAY_3: [f32; 4] = [69.0 / 255.0, 68.0 / 255.0, 79.0 / 255.0, 1.0]; // rgb(69, 68, 79)
...
pub const DARK_BLUE: [f32; 4] = [24.0 / 255.0, 64.0 / 255.0, 119.0 / 255.0, 1.0]; // rgb(24, 64, 119)
